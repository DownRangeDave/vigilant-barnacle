...
func _on_firstspawner3_body_entered(body):
	if body.name == "SpaceBody":
		var enemy1 = mob.instance()
		var enemy2 = mob.instance()
		var enemy3 = mob.instance()
		...
		if number == 15:
			...
			get_tree().get_root().add_child(enemy14)
			get_tree().get_root().add_child(enemy15)
func _on_firstspawner5_body_entered(body):
	if body.name == "SpaceBody":
		var enemy1 = mob.instance()
		var enemy2 = mob.instance()
		var enemy3 = mob.instance()
		...
		if number == 15:
			...
			get_tree().get_root().add_child(enemy14)
			get_tree().get_root().add_child(enemy15)
func _on_firstspawner4_body_entered(body):
	if body.name == "SpaceBody":
		var enemy1 = mob.instance()
		var enemy2 = mob.instance()
		var enemy3 = mob.instance()
		...
		if number == 15:
			...
			get_tree().get_root().add_child(enemy14)
			get_tree().get_root().add_child(enemy15)
func _on_firstspawner6_body_entered(body):
...
func _on_firstspawner7_body_entered(body):
	if body.name == "SpaceBody":
		var enemy1 = mob.instance()
		var enemy2 = mob.instance()
		var enemy3 = mob.instance()
...
func _on_firstspawner8_body_entered(body):
	if body.name == "SpaceBody":
		var enemy1 = mob.instance()
		var enemy2 = mob.instance()
		var enemy3 = mob.instance()
		...
		if number == 15:
			...
			get_tree().get_root().add_child(enemy14)
			get_tree().get_root().add_child(enemy15)
func _on_firstspawner10_body_entered(body):
	if body.name == "SpaceBody":
		var enemy1 = mob.instance()
		var enemy2 = mob.instance()
		var enemy3 = mob.instance()
		...
		if number == 15:
			...
			get_tree().get_root().add_child(enemy14)
			get_tree().get_root().add_child(enemy15)
func _on_firstspawner9_body_entered(body):
	if body.name == "SpaceBody":
		var enemy1 = mob.instance()
		var enemy2 = mob.instance()
		var enemy3 = mob.instance()
